...
if (count($committee_achievements) > 0) {
    foreach ($committee_achievements as $row) {
        ...
        echo '</div>';
        echo '</section>';
        echo "<a href='achievementsform.php?committee_ID={$row['committee_ID']}&achievement_id={$row['achievement_ID']}'>Update Achievement</a>";
        ?>

        </div><br>
           <form method="POST" action="ach.php" onsubmit="return confirm('Are you sure you want to delete this event?');">
