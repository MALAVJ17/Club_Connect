...
<form action="Login.php" method="post">
    ...
    <div class="container">
        ...
        <span>New user? <a style="text-decoration: none;" href="signup.php">Sign Up</a></span><br>
        <span>Forgot Password? <a style="text-decoration: none;" href="reset.php">Reset</a></span>
    </div>
</form>
</div>
