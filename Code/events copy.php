    ...
    if (!empty($events)) {
        foreach ($events as $event) {
          ?> <div class="rectangle" id="myTextBox"> <?php
            ...
            echo "<a href='eventform.php?committee_ID={$event['committee_ID']}&event_id={$event['Event_ID']}'>Update Event</a>";
           ?></div><br>
           <form method="POST" action="event.php" onsubmit="return confirm('Are you sure you want to delete this event?');">
