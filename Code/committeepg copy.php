...
// Function to redirect to login page after 5 seconds of inactivity
function startSessionTimeout() {
    $timeout = 1800; // 5 seconds
    $_SESSION['timeout'] = time() + $timeout;
}

// Check if committee ID is set and handle session timeout
if (isset($_GET['committee_ID'])) {
  ...
  // Retrieve the committee ID from the URL
  $committee_id = htmlspecialchars($_GET['committee_ID']);
  ...
  z-index: -100;
    ...
    function startSessionTimeout() {
        var timeout = setTimeout(function() {
            window.location.href = 'convenorloginpage.php';
    ...
    // Start session timeout countdown when the page is loaded
...
<main>
  ...
  .logout-container button:hover {
    background-color: #760000; /* Darker shade on hover */
  }
           </style>
<body>
