...
<div id="newUser">
  ...
  <h1><?php echo isset($_GET['achievement_id']) ? "Update Achievement" : "New Achievement"; ?></h1>
    <h1>Acheivements</h1>
    <fieldset class="row1">
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="achievement_id" value="<?php echo isset($_GET['achievement_id']) ? $_GET['achievement_id'] : ''; ?>">
        <input type="hidden" name="action_type" value="<?php echo isset($_GET['achievement_id']) ? 'update' : 'insert'; ?>">
        <div class="sbtbtn row input-row">
          <input type="submit" value="<?php echo isset($_GET['achievement_id']) ? 'Update' : 'Submit'; ?>">
        </div>
        </div>
    </fieldset>
  </form>
